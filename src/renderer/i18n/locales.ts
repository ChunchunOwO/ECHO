...
type FlexibleSettingsTranslationKey =
  | `mediaLibrary.${string}`
  | `likedPage.${string}`
...
type TranslationMap = Record<Exclude<TranslationKey, FlexibleSettingsTranslationKey>, string> & Partial<Record<FlexibleSettingsTranslationKey, string>>;

const mediaLibraryZhCN = {
  ...
  'mediaLibrary.settings.nativeMetadataReader.description': '使用 C++ 独立进程读取 FLAC、MP3、M4A 基础标签；不提取封面、不写 SQLite，失败时自动回退 TypeScript。',
  ...
  'mediaLibrary.settings.scanPerformance.description': '选择 ECHO Next 在曲库扫描时并行读取的文件数量。',
  ...
  'mediaLibrary.settings.bpm.description': '默认开启。开启后只会在播放当前歌曲时低优先级分析缺失 BPM，并把检测到的 BPM 写入歌曲标签；手动按钮仍可一次性补齐缺失 BPM。',
...
const mediaLibraryEnUS = {
  ...
  'mediaLibrary.settings.nativeMetadataReader.description': 'Use a standalone C++ process to read basic FLAC, MP3, and M4A tags; it does not extract covers or write SQLite, and falls back to TypeScript on failure.',
  ...
  'mediaLibrary.settings.scanPerformance.description': 'Choose how many files ECHO Next reads in parallel during library scans.',
  ...
  'mediaLibrary.settings.bpm.description': 'On by default. When enabled, missing BPM is analyzed at low priority while the current track plays and detected BPM is written to track tags. The manual button can still backfill missing BPM in one pass.',
...
const mediaLibraryJaJP = mediaLibraryEnUS;
const settingsAboutDangerZhTW = settingsAboutDangerZhCN;
const settingsAboutDangerJaJP = settingsAboutDangerEnUS;

const settingsIntegrationsExtraZhCN = {
...
const settingsIntegrationsExtraEnUS = {
...
const settingsIntegrationsExtraZhTW = settingsIntegrationsExtraZhCN;
const settingsIntegrationsExtraJaJP = settingsIntegrationsExtraEnUS;

const likedPageZhCN = {
  'likedPage.kicker': 'Library',
  'likedPage.title': '喜欢',
  'likedPage.summary': '{tracks} 首歌曲 · {albums} 张专辑',
  'likedPage.tab.tracks': '喜欢的歌曲',
  'likedPage.tab.albums': '喜欢的专辑',
  ...
  'likedPage.empty.description': '在歌曲或专辑页面点击爱心即可收藏到这里',
...
const likedPageEnUS = {
  ...
  'likedPage.tab.tracks': 'Liked Tracks',
  'likedPage.tab.albums': 'Liked Albums',
...
const likedPageZhTW = likedPageZhCN;
const likedPageJaJP = likedPageEnUS;
...
const songsPageZhCN = {
  ...
  'songs.scan.progress': '正在{phase}... {progress} 个文件，新增 {added}，更新 {updated}，跳过 {skipped}',
  ...
  'songs.duplicates.todo': 'TODO: 手动指定代表版本。',
} satisfies Partial<Record<FlexibleSettingsTranslationKey, string>>;
...
const songsPageEnUS = {
  ...
  'songs.scan.progress': 'Now {phase}... {progress} files, {added} added, {updated} updated, {skipped} skipped',
  ...
  'songs.duplicates.todo': 'TODO: manually choose representative version.',
} satisfies Partial<Record<FlexibleSettingsTranslationKey, string>>;
...
const zhCN: TranslationMap = {
  ...
  'audioSignalPath.summary.bitPerfectCandidate': '纯净候选',
  'audioSignalPath.summary.checkOutput': '需要检查输出',
  ...
  'audioSignalPath.summary.pathError': '链路异常',
...
const zhTW: TranslationMap = {
  ...
  'audioSignalPath.summary.bitPerfectCandidate': '純淨候選',
  'audioSignalPath.summary.checkOutput': '需要檢查輸出',
  ...
  'audioSignalPath.summary.nativePlayback': '原生播放',
  'audioSignalPath.summary.pathError': '鏈路異常',
...
const jaJP: TranslationMap = {
  ...
  'audioSignalPath.summary.bitPerfectCandidate': 'クリーン候補',
  'audioSignalPath.summary.checkOutput': '出力確認が必要',
  ...
  'audioSignalPath.summary.pathError': 'チェーン異常',
  'audioSignalPath.summary.protecting': '保護中',
...
const enUS: TranslationMap = {
  ...
  'audioSignalPath.summary.bitPerfectCandidate': 'Clean candidate',
  'audioSignalPath.summary.checkOutput': 'Output needs checking',
  ...
  'audioSignalPath.summary.pathError': 'Chain error',
