...
const zhCN: TranslationMap = {
  ...
  'audioDrawer.option.automix': '启用 Automix 实验',
  'audioDrawer.option.automixActive': '当前播放已进入 Automix 预混路径。',
  'audioDrawer.option.automixDescription': '实验功能，默认关闭。只有手动开启后才会在队列连续播放时自动把当前歌曲尾段与下一首重叠淡入淡出。',
  ...
  'settings.playback.automix.description': '实验功能，默认关闭。只有手动开启后，连续队列才会提前准备下一首，并用预混路径把尾段与下一首智能衔接。',
  'settings.playback.automix.title': 'Automix 智能过渡实验',
...
const zhTW: TranslationMap = {
  ...
  'audioDrawer.option.automix': '啟用 Automix 實驗',
  'audioDrawer.option.automixActive': '目前播放已進入 Automix 預混路徑。',
  'audioDrawer.option.automixDescription': '實驗功能，預設關閉。只有手動開啟後，才會在佇列連續播放時自動把目前歌曲尾段與下一首重疊淡入淡出。',
  ...
  'settings.playback.automix.description': '實驗功能，預設關閉。只有手動開啟後，連續佇列才會提前準備下一首，並用預混路徑把尾段與下一首智慧銜接。',
  'settings.playback.automix.title': 'Automix 智慧過渡實驗',
...
const jaJP: TranslationMap = {
  ...
  'audioDrawer.option.set': '設定',
  'audioDrawer.option.automix': 'Automix 実験を有効化',
  'audioDrawer.option.automixActive': '現在の再生は Automix のプリミックス経路を使用しています。',
  'audioDrawer.option.automixDescription': '実験機能です。既定ではオフで、手動で有効化した場合のみキュー再生中に現在の曲の終端と次の曲を自動で重ねてクロスフェードします。',
  ...
  'settings.playback.automix.description': '実験機能です。既定ではオフで、手動で有効化した場合のみ連続キューで次の曲を先に準備し、プリミックス経路で終端と次の曲を自然につなぎます。',
  'settings.playback.automix.title': 'Automix スマート遷移実験',
...
const enUS: TranslationMap = {
  ...
  'audioDrawer.option.automix': 'Enable Automix experiment',
  'audioDrawer.option.automixActive': 'Current playback is running through the Automix premix path.',
  'audioDrawer.option.automixDescription': 'Experimental and off by default. Only manual opt-in lets continuous queue playback overlap the current outro with the next intro using an automatic crossfade.',
  ...
  'settings.playback.automix.description': 'Experimental and off by default. Only manual opt-in lets continuous queues prepare the next track early and blend the outro into the next track through the premix path.',
  'settings.playback.automix.title': 'Automix Smart Transitions Experiment',
